...
<div class="navbar navbar-default">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <?php echo form_open_multipart('pengarang/create/'.$this->uri->segment(3)); ?>
                                                <legend>Tambah Data Pengarang</legend>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="kode_pengarang" name="kode_pengarang" placeholder="Input field" >
                                                
                                                    <label for="">Nama Pengarang</label>
                                                    <input type="text" class="form-control" id="nama_pengarang" name="nama_pengarang" placeholder="Input field" >
                                                </div>
