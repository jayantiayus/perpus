                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <?php echo form_open_multipart('kategori/create/'.$this->uri->segment(3)); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="id_kategori" name="id_kategori" placeholder="Input field" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Nama Kategori</label>
                                                    <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Input field" >
                                                </div>
